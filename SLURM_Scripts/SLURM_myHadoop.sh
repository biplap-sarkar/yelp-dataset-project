...
#SBATCH --mail-user=sbhukar@buffalo.edu
#SBATCH --output=Result_word_count.out
#SBATCH --error=Result_word_count.out
...
$HADOOP_HOME/bin/hadoop --config $HADOOP_CONF_DIR jar wordcountsample.jar sample.WordCount README.txt output_wordcount
